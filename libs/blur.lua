...
local GenUid; do -- Generate unique names for RenderStepped bindings
	...
	function GenUid()
		id = id + 1
		return concatTable{'neon',tostring(id)}
	end
end
...
function module:BindFrame(frame, properties)
	...
	f.Name = frame.Name
	local originalTransparency = properties.Transparency
	...
	local function UpdateOrientation(fetchProps)
		...
		if fetchProps then
			properties.Transparency = frame.Visible and originalTransparency or 1
